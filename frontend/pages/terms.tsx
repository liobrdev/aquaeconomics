  ...
  render() {
    const breadcrumbList: IBreadcrumbListItem[] = [
      ...
      },
      {
        ...
        item: "https://aquaeconomics.com/terms"
      }
    ];
    ...
    return (
      <>
        <Head>
          <title>Terms and Conditions &mdash; Aqua Economics &amp; Engineering</title>
        ...
        <main className='Page Page--legal'>
          <div className='LegalText'>
            ...
            <ul>
              <li>
                <p><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named AQUAECONOMICS.LIOBR.DEV.</p>
              </li>
              <li>
              ...
              <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to LIOBR.DEV.</p>
              </li>
              <li>
              ...
              <li>
                <p><strong>Website</strong> refers to AQUAECONOMICS.LIOBR.DEV, accessible from <a href="https://aquaeconomics.liobr.dev" rel="external nofollow noopener noreferrer" target="_blank">https://aquaeconomics.liobr.dev</a>.</p>
              </li>
              <li>
            ...
            <ul>
              <li>By email: contact@liobr.dev</li>
            </ul>
          </div>
        </main>
      </>
